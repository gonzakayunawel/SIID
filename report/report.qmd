...
Los resultados demuestran que, a través de modelos de clasificación como **Logistic Regression** o **XGBoost**, es posible anticipar interrupciones en la entrega con una precisión superior al **95%**, así como el uso de modelos como **Linear Regression** podemos hacer una previsión de *Sales* con R^2^ de 1. El análisis se estructura en cuatro pilares: contextualización del negocio y calidad de datos, diagnóstico exploratorio con análisis probabilístico, benchmarking de modelos predictivos y recomendaciones de optimización estratégica.

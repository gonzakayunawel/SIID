...
Los resultados demuestran que, a través de modelos de clasificación como **Logistic Regression** o **XGBoost**, es posible anticipar interrupciones en la entrega con una precisión superior al **95%**. Por otra lado, con el uso de modelos de la familia de **Linear Regression**, podemos hacer una previsión de *Sales* con R^2^ igual a 1. 

  ...
  pdf:
    ...
    include-in-header:
      - text: |
          ...
          \setkomafont{title}{\raggedright\bfseries\Large}
          \setkomafont{subtitle}{\raggedright\mdseries\normalsize}
          \setkomafont{author}{\raggedright\mdseries\normalsize}
          \setkomafont{date}{\raggedright\mdseries\small}
execute:
  warning: false
  message: false
  cache: false
